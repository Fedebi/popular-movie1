...
/**
 * {@link MovieAdapter} exposes a list of movie Poster to a
 * {@link RecyclerView}
 */
public class MovieAdapter extends RecyclerView.Adapter<MovieAdapter.MovieAdapterViewHolder> {
    ...
    public interface MovieAdapterOnClickHandler {
        void onClick(MovieDetail moreDetails);
    }
    ...
    public class MovieAdapterViewHolder extends RecyclerView.ViewHolder implements OnClickListener {
        ...
        public void onClick(View v) {
            ...
            MovieDetail movieDetail = mMovieDetails[adapterPosition];
    ...
    public void onBindViewHolder(MovieAdapterViewHolder movieAdapterViewHolder, int position) {
        String moviePosters = mMovieDetails[position].getPoster_path();

        String uri_base = "http://image.tmdb.org/t/p/w185";
        Uri uri = Uri.parse(uri_base).buildUpon()
                .appendEncodedPath(moviePosters).build();
    ...
    /**
     * This method is used to set the movie poster on a Adapter if we've already
     * created one. This is handy when we get new data from the web but don't want to create a
     * new Adapter to display it.
     *
     * @param movieDetails The new movie Details to be displayed.
     */
    public void setMovieData(MovieDetail[] movieDetails) {
